...
- [Batch Virtual Adversarial Training for Graph Convolutional Networks](https://www.notion.so/Batch-virtual-adversarial-training-for-graph-convolutional-networks-dbf8320758554240b0ba6e5d9007269d)
    - GCN based
    - semi-supervised
    - 改良VAT，提出
        - sample-based VAT
...
## August 5
- [x] 請cw跑[對照組實驗(何向南、SVAT OVAT)](https://docs.google.com/spreadsheets/d/1_vNZXMDKKCyYl0X6YyPbe9j0Aarkm4nczVmaS0I9wlI/edit?fbclid=IwAR35A63OLY7vWx1lrfDqwqnaaJJF0em4j-K5xEZqEurbGLn7QKgjGTXbcYo#gid=0)
- [ ] GCN smoothness 假設
- [ ] 可能的架構
- [ ] Introduction
- [ ] GCN
